...
import { WorkflowInstance, WorkflowInstanceStatus } from '@app/core/domain/workflow-instance.entity';
...
export class WorkflowService {
    constructor(
        @Inject('WorkflowInstanceRepository') private instanceRepo: WorkflowInstanceRepositoryPort,
        @Inject('TaskRepository') private taskRepo: TaskRepositoryPort,
        @Inject('QueuePort') private queue: QueuePort,
    ) { }

    async startWorkflow(workflowId: string, payload: any): Promise<{ instanceId: string }> {
